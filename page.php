...
$headers = 'From: contact@beingtraveler.in' . "\r\n" .
 ...
 // Send email alert
    ...
    $msg = "A New enquiry has been received. Details are: \n\n".
           "Name: $fname \n".
           "Email: $email \n".
           "Mobile: $mobile \n".
           "Subject: $subject \n".
...
<meta name='description' content='Explore the different sections of the BeingTraveler website, your gateway to incredible travel experiences.'>
...
s1.async=true;
s1.src='https://embed.tawk.to/64ae97c094cf5d49dc631d40/1h5501j2n';
s1.charset='UTF-8';
